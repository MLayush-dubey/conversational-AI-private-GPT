...
st.set_page_config(page_title="Conversational AI", page_icon="💬", layout="centered")
...
with st.sidebar:
    ...
    for cid, title in conversations.items():
        ...
        # Adjust column width ratios for more balanced centering
        ...
        with col2:
            # Use an empty string as label for vertical centering, add help="Delete" for hover effect
            st.write("")  # This ensures vertical centering
